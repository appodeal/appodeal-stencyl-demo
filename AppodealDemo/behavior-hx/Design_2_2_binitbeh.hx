...
class Design_2_2_binitbeh extends ActorScript
{
	...
	override public function init()
	{
		...
		addMouseOverActorListener(actor, function(mouseState:Int, list:Array<Dynamic>):Void
		{
			...
			{
				Appodeal.setGender(1);
				Appodeal.setSmoking(0);
				Appodeal.setOccupation(0);
				Appodeal.setAlcohol(0);
				Appodeal.setBirthday("31/12/1990");
				Appodeal.setInterests("cinema, work, science, cars");
				Appodeal.setEmail("hi@appodeal.com");
				Appodeal.setRelation(0);
				Appodeal.setAge(25);
